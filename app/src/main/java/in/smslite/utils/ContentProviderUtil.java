...
public class ContentProviderUtil {
  ...
  public static void writeReceivedSms(Message message, String serviceCenterAddress, Context context) {
    ...
    contentValue.put(android.provider.Telephony.TextBasedSmsColumns.ADDRESS, message.address);
    contentValue.put(Telephony.TextBasedSmsColumns.BODY, message.body);
    ...
    contentValue.put(Telephony.TextBasedSmsColumns.DATE, message.timestamp);
