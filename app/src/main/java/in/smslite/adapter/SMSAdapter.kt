...
class SMSAdapter(var selectedItemAdapter: List<Message>, var listOfItemAdapter: List<Message>) : RecyclerView.Adapter<SMSViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SMSViewHolder, position: Int) {
        ...
        holder.setAddress(listOfItemAdapter[position].address)
        holder.setSummary(listOfItemAdapter[position].body)
        holder.setTime(listOfItemAdapter[position].receivedDate)
    }
